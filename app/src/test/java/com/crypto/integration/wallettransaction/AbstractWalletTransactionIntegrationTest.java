package com.crypto.integration.wallettransaction;


import com.crypto.wallettransaction.dataprovider.portfolio.WalletTransactionPortfolioEntityDAO;
import com.crypto.wallettransaction.dataprovider.purchaseorder.PurchaseOrderDaoEntity;
...
@SpringBootTest
public abstract class AbstractWalletTransactionIntegrationTest {

    @Autowired
    private PurchaseOrderDaoEntity purchaseOrderDao;
    @Autowired
